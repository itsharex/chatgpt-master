...
INSERT INTO `sys_dict` (`id`, `create_user`, `create_time`, `update_user`, `update_time`, `label`, `value`, `dict_type`, `css_class`, `list_class`, `is_default`, `sort`, `status`, `deleted`, `remark`) VALUES (61,'System', '2025-02-17 12:05:41', 'System', '2025-02-17 12:05:58', 'Dify', '6', 'gpt_local_model', '', 'default', 0, 6, 1, 0, '');
