package com.master.chat.llm.deepseek;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.master.chat.llm.deepseek.constant.DeepSeekConst;
import com.master.chat.llm.openai.OpenAiApi;
...
public class DeepSeekClient {
    ...
    public List<Item> editImages(java.io.File image, String prompt) {
        com.master.chat.llm.openai.entity.images.ImageEdit imageEdit = com.master.chat.llm.openai.entity.images.ImageEdit.builder().prompt(prompt).build();
     ...
     * @return Item  list
     */
    public List<Item> editImages(java.io.File image, com.master.chat.llm.openai.entity.images.ImageEdit imageEdit) {
        return this.editImages(image, null, imageEdit);
    }
     ...
     * @return Item list
     */
    public List<Item> editImages(java.io.File image, java.io.File mask, com.master.chat.llm.openai.entity.images.ImageEdit imageEdit) {
        checkImage(image);
     ...
     * @return ImageResponse
     */
    public ImageResponse variationsImages(java.io.File image, com.master.chat.llm.openai.entity.images.ImageVariations imageVariations) {
        checkImage(image);
        checkImageFormat(image);
        checkImageSize(image);
        RequestBody imageBody = RequestBody.create(MediaType.parse("multipart/form-data"), image);
    ...
    public ImageResponse variationsImages(java.io.File image) {
        ...
        checkImageFormat(image);
        checkImageSize(image);
        com.master.chat.llm.openai.entity.images.ImageVariations imageVariations = com.master.chat.llm.openai.entity.images.ImageVariations.builder().build();
...
//    }
     ...
     * @return 答案
     */
    public <T extends com.master.chat.llm.openai.entity.chat.BaseChatCompletion> com.master.chat.llm.openai.entity.chat.ChatCompletionResponse chatCompletion(T chatCompletion) {
        if (chatCompletion instanceof ChatCompletion) {
            Single<com.master.chat.llm.openai.entity.chat.ChatCompletionResponse> chatCompletionResponse = this.openAiApi.chatCompletion((ChatCompletion) chatCompletion);
            return chatCompletionResponse.blockingGet();
        }
        Single<com.master.chat.llm.openai.entity.chat.ChatCompletionResponse> chatCompletionResponse = this.openAiApi.chatCompletionWithPicture((com.master.chat.llm.openai.entity.chat.ChatCompletionWithPicture) chatCompletion);
        return chatCompletionResponse.blockingGet();
    }
     ...
     * @return 答案
     */
    public com.master.chat.llm.openai.entity.chat.ChatCompletionResponse chatCompletion(List<Message> messages) {
     ...
     */
    public <R extends PluginParam, T> com.master.chat.llm.openai.entity.chat.ChatCompletionResponse chatCompletionWithPlugin(ChatCompletion chatCompletion, PluginAbstract<R, T> plugin) {
        ...
        com.master.chat.llm.openai.entity.chat.Functions functions = com.master.chat.llm.openai.entity.chat.Functions.builder()
        ...
        //调用OpenAi
        com.master.chat.llm.openai.entity.chat.ChatCompletionResponse functionCallChatCompletionResponse = this.chatCompletion(chatCompletion);
        ...
        com.master.chat.llm.openai.entity.chat.FunctionCall functionCall = com.master.chat.llm.openai.entity.chat.FunctionCall.builder()
        ...
        com.master.chat.llm.openai.entity.chat.ChatCompletionResponse chatCompletionResponse = this.chatCompletion(chatCompletion);
     ...
     * @return ChatCompletionResponse
     */
    public <R extends PluginParam, T> com.master.chat.llm.openai.entity.chat.ChatCompletionResponse chatCompletionWithPlugin(List<Message> messages, PluginAbstract<R, T> plugin) {
     ...
     * @return ChatCompletionResponse
     */
    public <R extends PluginParam, T> com.master.chat.llm.openai.entity.chat.ChatCompletionResponse chatCompletionWithPlugin(List<Message> messages, String model, PluginAbstract<R, T> plugin) {
     ...
     * @since 1.1.2
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantResponse assistant(com.master.chat.llm.openai.entity.assistant.Assistant assistant) {
        Single<com.master.chat.llm.openai.entity.assistant.AssistantResponse> assistantResponse = this.openAiApi.assistant(assistant);
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantResponse retrieveAssistant(String assistantId) {
        Single<com.master.chat.llm.openai.entity.assistant.AssistantResponse> assistant = this.openAiApi.retrieveAssistant(assistantId);
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantResponse modifyAssistant(String assistantId, com.master.chat.llm.openai.entity.assistant.Assistant assistant) {
        Single<com.master.chat.llm.openai.entity.assistant.AssistantResponse> assistantResponse = this.openAiApi.modifyAssistant(assistantId, assistant);
        return assistantResponse.blockingGet();
    }
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantListResponse<com.master.chat.llm.openai.entity.assistant.AssistantResponse> assistants(PageRequest pageRequest) {
        Single<com.master.chat.llm.openai.entity.assistant.AssistantListResponse<com.master.chat.llm.openai.entity.assistant.AssistantResponse>> assistants = this.openAiApi.assistants(pageRequest.getLimit(), pageRequest.getOrder(), pageRequest.getBefore(), pageRequest.getAfter());
     ...
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantFileResponse assistantFile(String assistantId, com.master.chat.llm.openai.entity.assistant.AssistantFile assistantFile) {
        Single<com.master.chat.llm.openai.entity.assistant.AssistantFileResponse> assistantFileResponse = this.openAiApi.assistantFile(assistantId, assistantFile);
     ...
     * @return 助手文件信息
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantFileResponse retrieveAssistantFile(String assistantId, String fileId) {
        Single<com.master.chat.llm.openai.entity.assistant.AssistantFileResponse> assistantFileResponse = this.openAiApi.retrieveAssistantFile(assistantId, fileId);
        return assistantFileResponse.blockingGet();
    }
     ...
     * @return 助手文件列表
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantListResponse<com.master.chat.llm.openai.entity.assistant.AssistantFileResponse> assistantFiles(String assistantId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
        Single<com.master.chat.llm.openai.entity.assistant.AssistantListResponse<com.master.chat.llm.openai.entity.assistant.AssistantFileResponse>> deleteResponse = this.openAiApi.assistantFiles(assistantId, pageRequest.getLimit(), pageRequest.getOrder(), pageRequest.getBefore(), pageRequest.getAfter());
        return deleteResponse.blockingGet();
    }
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantListResponse<MessageResponse> messages(String threadId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantListResponse<MessageFileResponse> messageFiles(String threadId, String messageId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.run.RunResponse run(String threadId, com.master.chat.llm.openai.entity.assistant.run.Run run) {
     ...
     * @since 1.1.6
     */
    public void runWithStream(String threadId, com.master.chat.llm.openai.entity.assistant.run.Run run, EventSourceListener eventSourceListener) {
        if (!run.isStream()) {
            run.setStream(true);
        }
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.run.RunResponse retrieveRun(String threadId, String runId) {
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.run.RunResponse modifyRun(String threadId, String runId, com.master.chat.llm.openai.entity.assistant.run.ModifyRun run) {
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantListResponse<com.master.chat.llm.openai.entity.assistant.run.RunResponse> runs(String threadId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.run.RunResponse submitToolOutputs(String threadId, String runId, com.master.chat.llm.openai.entity.assistant.run.ToolOutputBody toolOutputs) {
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.run.RunResponse cancelRun(String threadId, String runId) {
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.run.RunResponse threadRun(com.master.chat.llm.openai.entity.assistant.run.ThreadRun threadRun) {
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.run.RunStepResponse retrieveRunStep(String threadId, String runId, String stepId) {
     ...
     * @since 1.1.3
     */
    public com.master.chat.llm.openai.entity.assistant.AssistantListResponse<com.master.chat.llm.openai.entity.assistant.run.RunStepResponse> runSteps(String threadId, String runId, PageRequest pageRequest) {
        pageRequest = Optional.ofNullable(pageRequest).orElse(this.getPageRequest());
