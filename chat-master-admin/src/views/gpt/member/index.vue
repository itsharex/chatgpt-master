<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="80px">
      ...
      <el-form-item label="调用次数" prop="num">
        <el-input v-model="queryParams.num" placeholder="请输入调用次数" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="邀请人" prop="shareId">
        <el-input v-model="queryParams.shareId" placeholder="请输入邀请人" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['gpt:member:update']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['gpt:member:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['gpt:member:export']">导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="登录ip" prop="ip">
          <el-input v-model="form.ip" placeholder="请输入登录ip" />
        </el-form-item>
        <el-form-item label="调用次数" prop="num">
          <el-input v-model="form.num" placeholder="请输入调用次数" />
        </el-form-item>
        <el-form-item label="邀请人" prop="shareId">
          <el-input v-model="form.shareId" placeholder="请输入邀请人" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      pageMember(this.addDateRange(this.queryParams, this.dateRange)).then(res => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('/gpt/member/export', {
        ...this.queryParams
