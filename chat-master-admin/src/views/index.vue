    ...
    <div class="top">
      ...
      <div class="welcome">
        ...
        <div class="right">
          ...
          <div class="data">
            <div class="text">访问数</div>
            <div class="number">{{ totalData.allAccessCount }}</div>
          </div>
          <div class="data">
            <div class="text">系统任务</div>
            <div class="number">{{ totalData.allJobCount }}</div>
          </div>
        </div>
      </div>
    </div>
    <div class="content">
        ...
        <div class="project">
          ...
          <div>
            <div style="margin: 14px 40px;">
              <div>欢迎使用 chat-master开源大模型系统！</div>
      ...
      <div class="right">
        <div class="project">
          ...
          <div class="nav">
            <div class="nav-content" @click="jumpTo('index')">数据中心</div>
            <div class="nav-content" @click="jumpTo('sys/user')">用户管理</div>
            <div class="nav-content" @click="jumpTo('sys/dict')">字典管理</div>
            <div class="nav-content" @click="jumpTo('sys/config')">参数设置</div>
            <div class="nav-content" @click="jumpTo('sys/notice')">通知公告</div>
            <div class="nav-content" @click="jumpTo('monitor/job')">任务列表</div>
          </div>
        </div>
        <div class="project">
          <div class="title">
            <div class="title-left">安全指数</div>
          </div>
