    ...
    <div class="app-container">
        ...
        <el-form v-if="activeName == 'baseInfo'" ref="form" :model="baseInfo" label-width="130px">
            ...
            <el-form-item label="站点描述">
                <el-input type="textarea" :rows="3" style="width: 400px" placeholder="请填写站点描述" v-model="baseInfo.descrip">
                </el-input>
            </el-form-item>
            <el-form-item>
        ...
        <el-form v-if="activeName == 'wxInfo'" ref="form" :model="wxInfo" label-width="130px">
            <el-form-item label="小程序appid">
                <el-input style="width: 200px" placeholder="请填写小程序appid" v-model="wxInfo.maAppId"></el-input>
            </el-form-item>
            <el-form-item label="小程序secret">
                <el-input style="width: 200px" placeholder="请填写小程序secret" v-model="wxInfo.maSecret"></el-input>
            </el-form-item>
            <el-form-item label="小程序支付">
                <el-switch v-model="wxInfo.maPay" active-text="开启" :active-value="1" :inactive-value="0"
                    inactive-text="关闭">
                </el-switch>
            </el-form-item>
            ...
            <el-form-item label="公众号secret">
                <el-input style="width: 200px" placeholder="请填写公众号secret" v-model="wxInfo.mpSecret"></el-input>
            </el-form-item>
            <el-form-item label="公众号登陆">
                <el-switch v-model="wxInfo.mpLogin" active-text="开启" :active-value="1" :inactive-value="0"
                    inactive-text="关闭">
                </el-switch>
            </el-form-item>
            <el-form-item label="公众号支付">
                <el-switch v-model="wxInfo.mpPay" active-text="开启" :active-value="1" :inactive-value="0"
                    inactive-text="关闭">
                </el-switch>
            </el-form-item>
            <el-form-item label="支付商户号">
                <el-input style="width: 200px" placeholder="请填写微信支付商户号" v-model="wxInfo.mchNo">
                </el-input>
            </el-form-item>
            <el-form-item label="支付密钥V3">
                <el-input style="width: 200px" placeholder="请填写微信支付V3密钥" v-model="wxInfo.v3Secret">
                </el-input>
            </el-form-item>
