export default {
  common: {
    ...
    siteInfo: '© 2023 ChatMASTER 苏ICP备66668888号 江苏正在发展科技有限公司',
    userXieyi: '用户协议',
    privacyZhengce: '隐私政策',
    app: 'APP',
  ...
  login: {
    title: '多模型对话，畅所欲言',
    subTitle: '基于ChatGPT、文心一言、通义千问、讯飞星火、ChatGLM、豆包等主流大模型开发，支持多轮对话，具备内容创作、信息归纳总结等能力',
    quickStart: '快速开始',
